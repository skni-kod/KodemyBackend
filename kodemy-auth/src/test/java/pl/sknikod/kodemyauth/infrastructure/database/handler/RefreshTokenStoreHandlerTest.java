...
import pl.sknikod.kodemyauth.infrastructure.database.model.RefreshTokenRepository;
...
class RefreshTokenStoreHandlerTest extends BaseTest {
    @Mock
    ...
    @BeforeEach
    void setUp() {
        refreshTokenRepositoryHandler = new RefreshTokenStoreHandler(
