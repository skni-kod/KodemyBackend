...
public class OAuth2RestTemplate {
    ...
    public ResponseEntity<Map<String, Object>> exchange(@NonNull OAuth2UserRequest userRequest) {
        String userInfoUri = userRequest.getClientRegistration()
                ...
                .getUserInfoEndpoint()
                .getUri();
        return this.restTemplate.exchange(map(userInfoUri, userRequest), PARAMETERIZED_RESPONSE_TYPE);
    }
    ...
    public <T> ResponseEntity<T> exchange(
        ...
        return this.restTemplate.exchange(map(url, userRequest), responseType);
    }
